...
function wcpt_corner_options( $args= array() ){
  ...
  <div class="wcpt-editor-corner-options">
    ...
    <i class="wcpt-editor-row-duplicate" wcpt-duplicate-row title="Copy">
      <?php wcpt_icon('copy'); ?>
    </i>
...
function wcpt_elm_type_list( $element_types, $heading= false ){
  ...
  if( $heading ){
    ?>
    <span class="wcpt-block-editor-element-type-heading"><?php echo $heading; ?></span>
    <?php
  }
