...
<div class="wcpt-option-row">
  ...
  <div class="wcpt-input">
    ...
    <?php wcpt_pro_option('post_content', 'Content'); ?>
    </select>
  </div>
</div>
  ...
  <div class="wcpt-input" style="position: relative;">
    ...
    <span class="wcpt-additional-query-args-info wcpt-toggle wcpt-toggle-off" style="z-index: 1;">
      ...
      <span class="wcpt-toggle-tray">
        ...
        <p>
        If you need to filter products by category, taxonomy, tags, attributes or custom fields, you can use <a href="https://wcproducttable.com/documentation/shortcode-attribute" target="_blank">shortcode attributes</a> included in the plugin like [product_table id="123" category="cat 1, cat 2"]. Some of the shortcode attributes are <a href="https://pro.wcproducttable.com/" target="_blank">WCPT PRO</a> exclusive.
        </p>
      </span>
