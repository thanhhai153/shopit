    ...
    d.fn.extend({
      actual: function (e, t) {
        ...
        var n,
          a,
          i = d.extend(
            { absolute: !1, clone: !1, includeMargin: !1, display: "block" },
            t
          ),
          o = this.eq(0);
        if (!0 === i.clone)
          ...
          var u,
            ...
            s = "";
          (n = function () {
            (u = o.parents().addBack().filter(":hidden")),
              (s +=
                "visibility: hidden !important; display: " +
                i.display +
                " !important; "),
              !0 === i.absolute && (s += "position: absolute !important; "),
              u.each(function () {
                var e = d(this),
                  t = e.attr("style");
  ...
  jQuery(document).ready(function (i) {
    i(".ot-vm-click #mega-menu-title").click(function () {
      ...
      i(".ot-submenu-top #mega_menu > li").each(function (e) {
        ...
        t.children(".sub-menu").css({ "margin-top": n, "min-height": a });
      }),
